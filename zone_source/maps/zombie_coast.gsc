...
include_weapons()
{
	...
	// 3/16/25 - Readded Wunderwaffe to the box
	include_weapon( "tesla_gun_zm", true, false, ::cotd_waffe_weighting );
...
cotd_waffe_weighting()
{
	waffes_in_box = 1;

	if ( IsDefined( level.pulls_since_last_tesla_gun ) )
	{
		// at 25 pulls or more, there will be 3 waffes in the box
